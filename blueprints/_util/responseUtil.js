...
var Ember = {
	 ...
	 */
	buildResponse: function ( model, records, associations, sideload = false, associatedRecords ) {
		...
		var json = {};
		console.log(`plural: ${plural} emberModelIdentity: ${emberModelIdentity} modelPlural: ${modelPlural} documentIdentifier: ${documentIdentifier}`)
